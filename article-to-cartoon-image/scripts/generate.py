...
class ComfyUIClient:
    def __init__(self, server_address="127.0.0.1:8188"):
        ...
        print(f"✅ 客户端初始化完成: {server_address}, ID: {self.client_id}")
...
if __name__ == "__main__":
    prompt = (
        ...
        if len(sys.argv) > 1
            ...
            "A cartoon image of a cat sitting on a windowsill, "
